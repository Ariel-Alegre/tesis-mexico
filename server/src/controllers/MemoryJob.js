...
const createRedactionTesis = async (req, res) => {
  upload(req, res, async (err) => {
    ...
    try {
      ...
      const newRedactionTesis = await MemoryJob.create({
        title,
        description,
        titleForm,
        titleForm2,
...
const updateRedactionTesis = async (req, res) => {
  upload(req, res, async (err) => {
    ...
    try {
      ...
      const RedactionTesisRecord = await MemoryJob.findByPk(id);
...
const allRedactionTesis = async (req, res) => {
    ...
    try {
 const allredactiontesis = await MemoryJob.findAll()
