const { AcademicAdvising } = require('../db');
...
const createRedactionTesis = async (req, res) => {
  upload(req, res, async (err) => {
    ...
    try {
      ...
      const newRedactionTesis = await AcademicAdvising.create({
        title,
        description,
        titleForm,
        titleForm2,
...
const updateRedactionTesis = async (req, res) => {
  upload(req, res, async (err) => {
    ...
    try {
      ...
      const RedactionTesisRecord = await AcademicAdvising.findByPk(id);
...
const allRedactionTesis = async (req, res) => {
    ...
    try {
 const allredactiontesis = await AcademicAdvising.findAll()
