...
function EditThesisAdvice({ formData, setFormData, dataRedactionTesis,setPreviewgImage, previewgImage }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const url = formData.id
        ? `https://tesis-mexico-production.up.railway.app/api/academi/${formData.id}`
        : `https://tesis-mexico-production.up.railway.app/api/academi`;
...
export default EditThesisAdvice;
