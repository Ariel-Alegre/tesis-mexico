...
function EditScientificArticle({ formData, setFormData, dataRedactionTesis,setPreviewgImage, previewgImage }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const url = formData.id
        ? `https://tesis-mexico-production.up.railway.app/api/scientificarticle/${formData.id}`
        : `https://tesis-mexico-production.up.railway.app/api/scientificarticle`;
...
export default EditScientificArticle;
