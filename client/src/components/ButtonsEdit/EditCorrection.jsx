...
function EditCorrection({ formData, setFormData, dataRedactionTesis,setPreviewgImage, previewgImage }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const url = formData.id
        ? `https://tesis-mexico-production.up.railway.app/api/correction/${formData.id}`
        : `https://tesis-mexico-production.up.railway.app/api/correction`;
