...
function EditMonograph({ formData, setFormData, dataRedactionTesis,setPreviewgImage, previewgImage }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const url = formData.id
        ? `https://tesis-mexico-production.up.railway.app/api/monograph/${formData.id}`
        : `https://tesis-mexico-production.up.railway.app/api/monograph`;
