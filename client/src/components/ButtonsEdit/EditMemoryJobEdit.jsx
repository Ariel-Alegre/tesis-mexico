...
function EditMemoryJobEdit({ formData, setFormData, dataRedactionTesis,setPreviewgImage, previewgImage }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const url = formData.id
        ? `https://tesis-mexico-production.up.railway.app/api/memoryjob/${formData.id}`
        : `https://tesis-mexico-production.up.railway.app/api/memoryjob`;
...
export default EditMemoryJobEdit;
