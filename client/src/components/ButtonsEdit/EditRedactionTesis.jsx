...
function EditRedactionTesis({ formData, setFormData, dataRedactionTesis,setPreviewgImage, previewgImage }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const url = formData.id
        ? `https://tesis-mexico-production.up.railway.app/api/redaction-tesis/${formData.id}`
        : `https://tesis-mexico-production.up.railway.app/api/redaction-tesis`;
...
export default EditRedactionTesis;
