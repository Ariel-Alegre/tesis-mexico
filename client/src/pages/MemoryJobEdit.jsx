...
import EditMemoryJobEdit from "../components/ButtonsEdit/EditMemoryJobEdit";
  ...
  useEffect(() => {
    ...
    React.useEffect(() => {
      const fetchData = async () => {
        const res = await fetch('https://tesis-mexico-production.up.railway.app/api/memoryjob'); // ajusta si es GET /api/home
  ...
  return (
    <div>
           <div style={{margin: "20px", position: "fixed", zIndex: 2000}}>
                  <EditMemoryJobEdit previewgImage={previewgImage} setPreviewgImage={setPreviewgImage} formData={formData} setFormData={setFormData} dataRedactionTesis={dataRedactionTesis} />
                </div> 
