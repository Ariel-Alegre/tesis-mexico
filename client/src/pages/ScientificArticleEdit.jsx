...
import EditScientificArticle from "../components/ButtonsEdit/EditScientificArticle";

const ScientificArticleEdit = () => {
  ...
  useEffect(() => {
    ...
    React.useEffect(() => {
      const fetchData = async () => {
        const res = await fetch('https://tesis-mexico-production.up.railway.app/api/scientificarticle'); // ajusta si es GET /api/home
  ...
  return (
    <div>
              <div style={{margin: "20px", position: "fixed", zIndex: 2000}}>
                  ...
                  <EditScientificArticle previewgImage={previewgImage} setPreviewgImage={setPreviewgImage} formData={formData} setFormData={setFormData} dataRedactionTesis={dataRedactionTesis} />
                </div> 
...
export default ScientificArticleEdit;
