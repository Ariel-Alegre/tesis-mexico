...
import EditThesisAdvice from "../components/ButtonsEdit/EditThesisAdvice";

const ThesisAdviceEdit = () => {
  ...
  useEffect(() => {
    ...
    React.useEffect(() => {
      const fetchData = async () => {
        const res = await fetch('https://tesis-mexico-production.up.railway.app/api/academi'); // ajusta si es GET /api/home
  ...
  return (
    <div>
           <div style={{margin: "20px", position: "fixed", zIndex: 2000}}>
                  <EditThesisAdvice previewgImage={previewgImage} setPreviewgImage={setPreviewgImage} formData={formData} setFormData={setFormData} dataRedactionTesis={dataRedactionTesis} />
                </div> 
...
export default ThesisAdviceEdit;
