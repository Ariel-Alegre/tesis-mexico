...
import EditStatisticalAnalysis from "../components/ButtonsEdit/EditStatisticalAnalysis";

const StatisticalAnalysisEdit = () => {
  ...
  useEffect(() => {
    ...
    React.useEffect(() => {
      const fetchData = async () => {
        const res = await fetch('https://tesis-mexico-production.up.railway.app/api/statisticalanalysis'); // ajusta si es GET /api/home
  ...
  return (
    <div>
             <div style={{margin: "20px", position: "fixed", zIndex: 2000}}>
                  <EditStatisticalAnalysis previewgImage={previewgImage} setPreviewgImage={setPreviewgImage} formData={formData} setFormData={setFormData} dataRedactionTesis={dataRedactionTesis} />
                </div> 
...
export default StatisticalAnalysisEdit;
